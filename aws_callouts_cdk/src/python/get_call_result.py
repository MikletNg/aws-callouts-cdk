...
def lambda_handler(event, context):
    ...
    s3.upload_file(filename, os.environ['S3Bucket'],
                   'report/' + task_id + "_result.xlsx")

    excelDownloadUrl = create_presigned_url(os.environ['S3Bucket'],
                                            'report/' + task_id + "_result.xlsx")
    ...
    return {
        ...
        "ExcelKey": 'report/' + task_id + "_result.xlsx",
